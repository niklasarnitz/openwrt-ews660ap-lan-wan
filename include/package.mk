...
HASH_PREPARED=$(shell $(call find_md5,${CURDIR} $(PKG_FILE_DEPENDS),))
...
DOWNLOAD_RDEP += $(STAMP_PREPARED) $(STAMP_PREPARED)_$(HASH_PREPARED)
...
ifeq ($(DUMP)$(filter prereq clean refresh update,$(MAKECMDGOALS)),)
  ifneq ($(if $(QUILT),,$(CONFIG_AUTOREBUILD)),)
    define Build/Autoclean
      $(PKG_BUILD_DIR)/.dep_files: $(STAMP_PREPARED)_$(HASH_PREPARED)
      $(call rdep,${CURDIR} $(PKG_FILE_DEPENDS),$(STAMP_PREPARED)_$(HASH_PREPARED),$(PKG_BUILD_DIR)/.dep_files,-x "*/.dep_*")
...
define Build/CoreTargets
  ...
  $(STAMP_PREPARED) $(STAMP_PREPARED)_$(HASH_PREPARED): export PATH=$$(TARGET_PATH_PKG)
  $(STAMP_PREPARED) $(STAMP_PREPARED)_$(HASH_PREPARED): $(STAMP_PREPARED_DEPENDS)
	@-rm -rf $(PKG_BUILD_DIR)
	@mkdir -p $(PKG_BUILD_DIR)
	touch $(STAMP_PREPARED)_check $(STAMP_PREPARED)_$(HASH_PREPARED)_check
	$(foreach hook,$(Hooks/Prepare/Pre),$(call $(hook))$(sep))
	$(Build/Prepare)
	$(foreach hook,$(Hooks/Prepare/Post),$(call $(hook))$(sep))
	touch $(STAMP_PREPARED) $(STAMP_PREPARED)_$(HASH_PREPARED)

  $(call Build/Exports,$(STAMP_CONFIGURED))
  $(STAMP_CONFIGURED): $(if $(CONFIG_AUTOREBUILD),$(STAMP_PREPARED)_$(HASH_PREPARED),$(STAMP_PREPARED)) $(STAMP_CONFIGURED_DEPENDS)
  ...
  $(_pkg_target)prepare: $(if $(CONFIG_AUTOREBUILD),$(STAMP_PREPARED)_$(HASH_PREPARED),$(STAMP_PREPARED))
